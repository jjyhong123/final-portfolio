...
function initMap() {
    ...
    var styles = [{"stylers":[{"saturation":0},{"gamma":0.8},{"lightness":4},{"visibility":"on"}]},{"featureType":"landscape.natural","stylers":[{"visibility":"on"},{"color":"#5dff00"},{"gamma":4.97},{"lightness":-5},{"saturation":100}]}];
        var mapOptions = {
        zoom: zoom,
        center: cordinates,
...
function contactFormSetup() {
    ...
    $('#contact-form').on('submit', function(e) {
        ...
        if( required === 0 ) {
            $.ajax({
                type: 'POST',
                url: 'https://script.google.com/macros/s/AKfycbxPWN1VVxaDLKFkizlIHNCNDYWzz3g8LW-a9zYM/exec',
                data: {
                    name: name,
                    email: email,
                    message: message
                ...
                success: function(data) {
                    ...
                    showAlertBox(data.result, "Your message was sent successfully!");
                },
                error: function(data) {
                    showAlertBox(data.result, "Oops! Something went wrong. Try contacting me directly.");
                }
            });
        }
    });
